                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" placeholder="Masukan Nomor Identitas" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Email:</label>
                                            <input type="email" name="email_daftar" class="form-control" placeholder="Masukan Alamat Email">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sekolah" class="form-control" placeholder="Masukan Nama Asal Sekolah">
                                        </div>
                                    </div>
                                </div>
                                <div class="alert alert-primary">
                                            ...
                                            <div class="table-responsive-sm">
                                                <table class="table table-sm table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="indonesia[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="indonesia[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="indonesia[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="indonesia[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="indonesia[]" class="form-control" style="width: 60px;height: 50px" value="0"></td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="inggris[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="inggris[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="inggris[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="inggris[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="inggris[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="mtk[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="mtk[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="mtk[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="mtk[]" class="form-control" style="width: 60px;height: 50px" value="0"></td>
                                                        <td><input type="number" name="mtk[]" class="form-control" style="width: 60px;height: 50px" value="0"></td> 
