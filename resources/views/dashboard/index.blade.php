                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" id="btn-edit-registrasi" class="btn btn-warning sm"
                                    data-toggle="modal" data-target="#formEditRegistrasiModal" onclick="enable()"
                                    data-id="{{ $pendaftar->no_reg }}">Edit</button>
                            </td>
                            @else
                            <td>
        ...
        <div class="container-fluid">
            ...
            <div class="overview-wrap">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" data-toggle="modal" data-target="#importNilaiModal"
                        ...
                        Excel</button>
                    <button type="button" data-toggle="modal" data-target="#importSoalModal" class="btn btn-primary"><i
                            class="fa fa-file-excel"></i> Import Soal Dari File
                        Excel</button>
                </div>
            </div>
            <hr />
            <div class="table-responsive">
                <form action="/admin/fungsi-seleksi" method="post">
                    @csrf
                    <button type="submit" class="btn btn-warning"><i class="fa fa-warehouse"></i> Jalankan Fungsi
